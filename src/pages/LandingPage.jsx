      ...
      <section className="pt-32 md:pt-48 pb-16 px-4 md:px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 px-6">
            ...
            <a href="./downloads/bpos.apk" className="w-full sm:w-auto px-8 py-4 bg-green-600 text-white rounded-2xl font-bold hover:bg-green-700 shadow-xl flex items-center justify-center gap-2">
